    ...
    <div className="w-full min-h-screen bg-[#f8f9fa] text-gray-800">
      ...
      <section className="max-w-6xl mx-auto px-4 -mt-28 relative z-20">
        <form onSubmit={handleSearch} className="bg-[#1a3a4b] rounded-xl p-6 md:p-8 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <button type="submit" className="bg-[#b3925c] text-white font-bold rounded">
              Search
            </button>
          </div>
        </form>
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        <div className="mb-10 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#b3925c]">Fresh from Post Ad</p>
            <h2 className="mt-2 text-3xl font-bold text-[#1a3a4b]">Latest Posted Properties</h2>
        ...
        {latestLoading ? (
          ...
          <div className="rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">{latestError}</div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {latestListings.map((property) => (
              <div
                ...
                className="overflow-hidden rounded-xl bg-white shadow-lg transition hover:shadow-2xl cursor-pointer"
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="mt-2 text-lg font-bold text-[#1a3a4b]">{property.title}</h3>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={t.name} className="bg-white rounded-xl shadow-lg p-8">
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center text-white">
          ...
          {/* ✅ EXPLORE PROPERTIES BUTTON - now links to /properties */}
          <button
            onClick={() => navigate("/properties")}
            className="mt-10 bg-[#b3925c] hover:bg-[#9c7b49] px-10 py-4 rounded-lg font-semibold text-lg transition"
          >
            Explore Properties
          </button>
        </div>
