...
export default function ForgotPassword({ onBackToLogin }) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-[#123B44] via-[#2A6F86] to-[#123B44]">
        ...
        <div className="w-full max-w-md">
          <div className="rounded-3xl bg-white/95 p-5 shadow-2xl backdrop-blur-sm sm:p-6 md:p-7">
            <div className="mb-6 text-center">
              <h1 className="mb-1 text-2xl font-bold text-[#123B44] sm:text-3xl">Forgot Password</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#123B44]">Email Address</label>
                <input
                  type="email"
                  value={email}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-lg bg-linear-to-r from-[#2A6F86] to-[#123B44] py-2.5 font-bold text-white transition hover:shadow-lg hover:scale-105 disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            <div className="mt-6 text-center">
              <button
                ...
                className="font-bold text-[#2A6F86] transition hover:text-[#123B44]"
              >
                Back to Login
              </button>
            </div>
