...
export default function Register({ onSwitchToLogin, onRegistered }) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      await registerUser({
        ...
        u_type: userType.charAt(0).toUpperCase() + userType.slice(1),
      })
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-br from-[#08306B] via-[#2171B5] to-[#08306B]">
      ...
      <div className="pointer-events-none absolute top-32 right-32 h-56 w-72 rotate-12 rounded-[3rem] bg-white/18"></div>
          ...
          {/* Card */}
            ...
            <h1 className="mb-1 text-2xl font-bold text-[#08306B] sm:text-3xl">Register Here</h1>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-linear-to-r from-[#2171B5] to-[#08306B] py-1.5 font-bold text-white transition hover:scale-105 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            <div className="grid grid-cols-1 gap-2 mb-2 sm:grid-cols-2">
              <button className="flex items-center justify-center gap-2 rounded-lg border-2 border-gray-300 bg-white py-1 font-semibold text-gray-700 transition hover:border-[#2171B5]">
              ...
              <button className="flex items-center justify-center gap-2 rounded-lg border-2 border-gray-300 bg-white py-1 font-semibold text-gray-700 transition hover:border-[#08306B]">
