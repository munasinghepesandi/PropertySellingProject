      ...
      <div className="pointer-events-none absolute bottom-0 left-0 h-40 w-full bg-gradient-to-r from-white/20 via-white/8 to-transparent"></div>
          ...
          {/* Card */}
            ...
            <div className="grid grid-cols-1 gap-2 mb-2 sm:grid-cols-2">
              <button type="button" onClick={() => window.alert('Google registration is not connected yet.')} className="flex items-center justify-center gap-2 rounded-lg border-2 border-gray-300 bg-white py-1 font-semibold text-gray-700 transition hover:border-blue-500">
              ...
              <button type="button" onClick={() => window.alert('Facebook registration is not connected yet.')} className="flex items-center justify-center gap-2 rounded-lg border-2 border-gray-300 bg-white py-1 font-semibold text-gray-700 transition hover:border-blue-600">
